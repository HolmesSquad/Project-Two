...
global randomColourChangerYellow # Creates a variable called randomColourChangerYellow which is used to change the lights to yellow
...
colourChanger=0
global ScoreW # Creates a variable called Score which is used to count the robot w score
ScoreW = 0
global ScoreY # Creates a variable called Score which is used to count the robot y score
ScoreY = 0
global TreasureRemaining # Creates a variable called TreasureRemaining
TreasureRemaining = 4
global WCollected # Creates a variable called WCollected
WCollected = 0
global YCollected # Creates a variable called YCollected
YCollected = 0
...
class interface:#This is the class for all interface elements
    def __init__(self, name):
        ...
        self.level1_button = Button(name, text="Level 1", width = 20, command=self.level1, bg = "Yellow")#This is the constructor for the Level1 button 
        self.level1_button.place(x = 1110, y = 200)#Places the button at those x & y coords
        ...
        self.level2_button.place(x = 1110, y = 250)#Places the button at those x & y coords

        self.timerShow_label = Label(name, text = "", width = 7, font = ("Arial", 16)) #This is the constructor for the 1st Timer label
        self.timerShow_label.place(x = 1170, y = 30)#Places the button at those x & y coords

        self.timer_label= Label(name,text ="Timer", width = 5, font = ("Arial", 16))#This is the constructor for the 2nd Timer label
        self.timer_label.place(x = 1110, y = 30)#Places the button at those x & y coords
        ...
        self.treasures_label.place(x = 1110, y = 70)#Places the button at those x & y coords

        self.treasureShow_label = Label(name, text = TreasureRemaining, width = 16, font = ("Arial", 12))#This is the constructor for the 2nd Treasures remaining label
        self.treasureShow_label.place(x = 1110, y = 100)#Places the button at those x & y coords

        self.robot1Score_label = Label(name, text = "Yellow Robot Score: ", width = 16, height = 1, font = ("Arial", 12), anchor = N)#This is the constructor for the Robot Score label
        self.robot1Score_label.place(x = 1110, y = 300)#Places the button at those x & y coords

        self.robot1Score_label = Label(name, text = ScoreY, width = 16, font = ("Arial", 12))#This is the constructor for the Robot Score label
        self.robot1Score_label.place(x = 1110, y = 320)#Places the button at those x & y coords

        self.robot2Score_label = Label(name, text = "White Robot Score: ", width = 16, height = 1, font = ("Arial", 12), anchor = N)#This is the constructor for the Robot Score label
        self.robot2Score_label.place(x = 1110, y = 360)#Places the button at those x & y coords

        self.robot2Score_label = Label(name, text = ScoreW, width = 16, font = ("Arial", 12))#This is the constructor for the Robot Score label
        self.robot2Score_label.place(x = 1110, y = 380)#Places the button at those x & y coords
        
        self.YCollected_label = Label(name, text = "Yellow Collected: ", width = 16, height = 1, font = ("Arial", 12), anchor = N)
        self.YCollected_label.place(x = 1110, y = 420)#Places the button at those x & y coords

        self.YCollected_label = Label(name, text = YCollected, width = 16, font = ("Arial", 12))
        self.YCollected_label.place(x = 1110, y = 440)#Places the button at those x & y coords

        self.WCollected_label = Label(name, text = "White Collected: ", width = 16, height = 1, font = ("Arial", 12), anchor = N)
        self.WCollected_label.place(x = 1110, y = 480)#Places the button at those x & y coords

        self.WCollected_label = Label(name, text = WCollected, width = 16, font = ("Arial", 12))
        self.WCollected_label.place(x = 1110, y = 500)#Places the button at those x & y coords
    ...
    def start(self):#Starts the robot and timer
        ...
        interface.counterLabel(interface)#starts the counter function
...
#Starts and controls the timer functions and the timer finish function
     #creates a variable called counter
        #works almost identically to the level 1 code
    def count(main):
        ...
        if (RoboFinished != True):
            counter=counter+1
            if colourChanger!=3:# the colourchanger variable now counts to 3
    ...
    def counterStop(main,self):#stops the counter
        return True
...
def flipColour():#this controls the robot's colour
    ...
    if colourChanger==3: # if the variable colourChanger is the traffic lights will be set to Yellow
        c3po.speed=1
        robowait=False
